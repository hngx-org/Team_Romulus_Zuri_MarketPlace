...
CREATE TYPE "TRANSACTION_STATUS" AS ENUM ('pending', 'failed', 'success');
CREATE TYPE "badges" AS ENUM ('Beginner', 'Intermediate', 'Expert');
...
CREATE TABLE "promotion" (
  ...
  "maximum_discount_price" numeric(10, 2),
  "createdAt" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP),
  "updatedAt" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP)
);
...
CREATE TABLE "order_item" (
  ...
  "order_VAT" DECIMAL(8, 2) NOT NULL,
...
ALTER TABLE "product"
ADD FOREIGN KEY ("product_category_id") REFERENCES "product_category" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "user_track"
ADD FOREIGN KEY ("track_id") REFERENCES "tracks" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "product"
ADD FOREIGN KEY ("category_id") REFERENCES "product_category" ("id") ON DELETE CASCADE;
ALTER TABLE "product_sub_category"
ADD FOREIGN KEY ("parent_category_id") REFERENCES "product_category" ("id") ON DELETE CASCADE;
ALTER TABLE "track_promotion"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE;
ALTER TABLE "track_promotion"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
...
ALTER TABLE "promotion"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE;
ALTER TABLE "store_traffic"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "order"
ADD FOREIGN KEY ("customer_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "promo_product"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE;
ALTER TABLE "promo_product"
ADD FOREIGN KEY ("promo_id") REFERENCES "promotion" ("id") ON DELETE CASCADE;
ALTER TABLE "promo_product"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "sales_report"
ADD FOREIGN KEY ("order_id") REFERENCES "order" ("id") ON DELETE CASCADE;
ALTER TABLE "email_verification"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "skill"
ADD FOREIGN KEY ("parent_skill_id") REFERENCES "skill" ("id") ON DELETE CASCADE;
ALTER TABLE "assessment"
ADD FOREIGN KEY ("skill_id") REFERENCES "skill" ("id") ON DELETE CASCADE;
ALTER TABLE "question"
ADD FOREIGN KEY ("assessment_id") REFERENCES "assessment" ("id") ON DELETE CASCADE;
ALTER TABLE "answer"
...
ADD FOREIGN KEY ("user_assessment_id") REFERENCES "user_assessment" ("id") ON DELETE CASCADE;
ALTER TABLE "user_response"
ADD FOREIGN KEY ("question_id") REFERENCES "question" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "user_badge"
ADD FOREIGN KEY ("badge_id") REFERENCES "skill_badge" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("message_type_id") REFERENCES "mail_type" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("degree_id") REFERENCES "degree" ("id") ON DELETE CASCADE;
ALTER TABLE "education_detail"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "education_detail"
ADD FOREIGN KEY ("section_id") REFERENCES "section" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "social_user"
ADD FOREIGN KEY ("social_media_id") REFERENCES "social_user" ("id") ON DELETE CASCADE;
ALTER TABLE "custom_user_section"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "custom_user_section"
ADD FOREIGN KEY ("section_id") REFERENCES "section" ("id") ON DELETE CASCADE;
ALTER TABLE "custom_field"
ADD FOREIGN KEY ("custom_section_id") REFERENCES "custom_user_section" ("id") ON DELETE CASCADE;
ALTER TABLE "notification_setting"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "projects_image"
...
ADD FOREIGN KEY ("complaint_id") REFERENCES "complaint" ("id") ON DELETE CASCADE;
ALTER TABLE "complaint_comment"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "cart"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("customer_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "order_item"
ADD FOREIGN KEY ("merchant_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "order_item"
ADD FOREIGN KEY ("promo_id") REFERENCES "promotion" ("id") ON DELETE CASCADE;
...
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "product_review"
ADD FOREIGN KEY ("reply_id") REFERENCES "product_review" ("id") ON DELETE CASCADE;
ALTER TABLE "shop"
ADD FOREIGN KEY ("merchant_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "coupon"
ADD FOREIGN KEY ("merchant_id") REFERENCES "user" ("id") ON DELETE CASCADE;
...
ALTER TABLE "product"
ADD FOREIGN KEY ("rating_id") REFERENCES "user_product_rating" ("id") ON DELETE CASCADE;
ALTER TABLE "last_viewed_product"
ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;
ALTER TABLE "last_viewed_product"
ADD FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE;
